		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ui5futureviewui5project1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5futureviewui5project1-display": {
								"semanticObject": "ui5futureviewui5project1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.futureview.ui5project1",
									"url": sap.ui.require.toUrl("ui5/futureview/ui5project1")
								}
							}
						}
					}
